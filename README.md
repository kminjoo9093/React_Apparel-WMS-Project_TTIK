...
### 창고 관리 페이지 개발 [ 관련 코드 바로보기 ](./src/pages/storage/)
...
- **해결**
    ...
    - 데이터 적재 전 **상품 코드 중복 여부 체크**로 검증 로직 강화 [중복 체크 코드 바로가기](./src/pages/product/ProductCode.js#L17-L48)
...
### **3. 상품 상태 값 세분화로 재고 부족 오 분류 문제 해결**  [ 관련 코드 바로보기 ](./src/pages/product/ProductList.js#L112-L130)
