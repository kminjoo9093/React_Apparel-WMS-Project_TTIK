...
- [해당 창고의 구역/선반 정보를 실시간 조회하여 사용자 입력 가이드를 제공하여 오류 방지](./src/pages/storage/StorageAdd.js#L271-L275)
...
- **해결** &emsp; [ 관련 코드 바로가기 → ](./src/pages/product/ProductItem.js)
    - **입고 대기 상태(W)를 새롭게 정의**하여 상품 등록 시 기본값으로 설정하고, 실제 입고 처리 전까지
...
### **3. 상태 및 비즈니스 로직 분리를 통한 컴포넌트 구조 개선**
- **문제**
