...
const ProductModify = () => {
  ...
  const handleChange = (e, field) => {
    const value =
      field === "untprc" || field === "threshold" || field === "inbox_qty"
    ...
    <>
      ...
      >
        <div style={{ marginBottom: "50px" }}>
          ...
          >
            <span
              style={{ color: "#64748b", fontWeight: "bold", fontSize: "18px" }}
            >
              CODE: {product.gds_cd}
            </span>
        ...
        <div style={{ display: "flex", gap: "100px", marginBottom: "50px" }}>
          <div style={{ flex: 1 }}>
            ...
            <EditField
              label="브랜드"
              value={product.brand_nm || "정보 없음"}
              disabled
            />
            <EditField
              label="단가"
              value={product.untprc}
              onChange={(e) => handleChange(e, "untprc")}
              isNumber
              suffix="원"
            />
          </div>
          ...
          <div style={{ flex: 1 }}>
            ...
            <EditField
              label="입수 수량"
              value={product.inbox_qty}
              onChange={(e) => handleChange(e, "inbox_qty")}
              isNumber
              suffix="EA"
            />
          </div>
...
const EditField = ({ label, value, onChange, disabled, isNumber, suffix }) => (
  ...
  >
    <label style={{ color: "#64748b", fontWeight: "bold", fontSize: "16px" }}>
      {label}
    </label>
    <div
      style={{
    ...
    >
      ...
      />
      {suffix && (
        <span style={{ color: "#64748b", fontSize: "16px", minWidth: "40px" }}>
          {suffix}
        </span>
      )}
    </div>
