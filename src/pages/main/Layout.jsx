    ...
    try {
      ...
      data.forEach((item) => {
        ...
        if (
          ...
          item.storageName !== user?.tkcgStorage
        )
          return;
    ...
    <div className={styleLayout.appContainer}>
      {hasSidebarPermission && (
        <>
          ...
          ></div>
          <aside
            className={`${styleLayout.sidebar} ${isSidebarOpen ? styleLayout.sidebarActive : ""}`}
          >
            <div className={styleLayout.sidebarLogo}>
              <div className={styleLayout.logoMain}>
                {" "}
                <Link to="/ttik">TTIK</Link>
              </div>
              <div className={styleLayout.logoSub}>
            ...
            <nav className={styleLayout.sidebarNav}>
              {menus.map((menu) => {
                ...
                const isProductDetailActive =
                  ...
                  (menu.path.includes("/product/productDetail") ||
                    menu.name.includes("상품"));
      ...
      <div
        className={`${styleLayout.mainContent} ${!hasSidebarPermission ? styleLayout.fullWidth : ""}`}
      >
        <header className={styleLayout.topBar}>
          <div
            className={styleLayout.topBarLeft}
          ...
          <div className={styleLayout.topBarRight}>
              ...
              <div className={styleLayout.notificationContainer} ref={notiRef}>
                ...
                >
                  ...
                  {notifications.length > 0 && (
                    <span className={styleLayout.bellBadge}>
                      ...
                      {notifications.length > 0 ? (
                        notifications.map((n) => (
                          <li
                            ...
                            onClick={() =>
                              handleNotificationClick(n.id, "/product/list")
                            }
                          >
            ...
            <button className={styleLayout.logoutBtn} onClick={handleLogout}>
              로그아웃
            </button>
          </div>
        </header>
