  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setAlert({
        ...
        title: "Error",
        message:
          "이력을 불러오는 중 오류가 발생했습니다. (백엔드 로그 확인 필요)",
        ...
        <div className={styleHistory.HistoryListbox}>
          ...
          <div className={styleHistory.searchBox}>
            <div className={styleHistory.searchInput}>
              ...
              />
              <button
                className={styleHistory.HistoryBtn}
          ...
          <div className={styleHistory.timelineContainer}>
            {loading ? (
              <div className={styleHistory.loadingText}>
                데이터를 불러오는 중입니다...
              </div>
              ...
              historyList.map((item) => (
                <div key={item.id} className={styleHistory.timelineItem}>
                  <div
                    className={`${styleHistory.timelineDot} ${item.type === 0 ? styleHistory.inDot : styleHistory.outDot}`}
                  ></div>
                  ...
                  <div className={styleHistory.timelineContent}>
                    <div className={styleHistory.contentTop}>
                      <span
                        className={
                          item.type === 0
                            ? styleHistory.inBadge
                            : styleHistory.outBadge
                        }
                      >
                        처리일 -
                      </span>
