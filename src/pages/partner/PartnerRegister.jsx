  ...
  return (
    <>
      ...
      <div className={stylePartner.modalOverlay}>
        <div
          className={stylePartner.modalContent}
          onClick={(e) => e.stopPropagation()}
        >
          <button className={stylePartner.closeBtn} onClick={onClose}>
            &times;
          </button>
          <h2>거래처 등록</h2>
          <form onSubmit={handleSubmit}>
            ...
            <div className={stylePartner.modalItem}>
              ...
              />
              {brError && (
                <p style={{ color: "red", fontSize: "12px" }}>{brError}</p>
              )}
              {brResult && (
            ...
            <div className={stylePartner.modalItem}>
              ...
              />
              {telError && (
                <p style={{ color: "red", fontSize: "12px" }}>{telError}</p>
              )}
            </div>

            <button type="submit" className={stylePartner.submitBtn}>
              등록
            </button>
          </form>
        </div>
